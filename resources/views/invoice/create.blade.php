...
@section('content')
<!-- Page Menus -->
@component('components.menu_page')
<li class="nav-item{{request()->is('invoice/create') ? ' active' : ''}}">
  @can('view-invoice')
  <a class="nav-link text-dark text-decoration-none" id="create_record" href="{{route('invoice.index')}}" title='Go back'>
            ...
            <div id="1" class="item">
              <div class="row">
                <div class="form-group mb-1 col-sm-12 col-md-3">
                  <label for="item_name">{{trans('Item Description')}}</label>
                  <br>
