...
Route::middleware(['XSS'])->group(function () {
  ...
  /*
   * Access: Only authenticated and verified users
   */
  Route::middleware(['auth', 'verified'])->group(function () {
    ...
    # Invoices
    Route::resource('invoice', 'InvoiceController')->except(['destroy', 'update', 'index']);
    Route::get('invoices', 'InvoiceController@index')->name('invoice.index');
    Route::get('invoice', function () {
      return redirect()->intended(route('invoice.index'), 301);
    });
    Route::post('invoice/{id}/update', 'InvoiceController@update')->name('invoice.update');
    Route::get('invoice/status/{status_id}/{invoice_id}', 'InvoiceController@status')->name('invoice.status');
    Route::get('invoice/{id}/delete', 'InvoiceController@destroy')->name('invoice.destroy');
    Route::get('invoice/download', 'InvoiceController@download')->name('invoice.download');
    Route::get('invoice/download/{id}', 'InvoiceController@download')->name('invoice.downloadFile');
    Route::post('invoice/delete/selected', 'InvoiceController@delete_by_selection')->name('mass_delete_invoices');
    ...
    Route::resource('events', 'EventController')->except(['destroy', 'create', 'update']);
...
//Route::resource('employees', 'EmployeeController');
    ...
    Route::get('/client/invoice/payment', 'ClientInvoiceController@paidInvoices')->name('clientInvoicePaid');
    ...
    Route::namespace('Performance')->prefix('performance')->group(function () {

      Route::prefix('goal-type')->group(function () {
      ...
      Route::prefix('goal-tracking')->group(function () {
